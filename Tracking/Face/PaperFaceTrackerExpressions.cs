...
public static class PaperTrackerExpressions
{
    public static readonly TwoKeyDictionary<UnifiedExpressions, string, float> PaperTrackerExpressionMap = new()
    {
        ...
        { UnifiedExpressions.MouthUpperLeft, "/mouthLeft", 0f },
        { UnifiedExpressions.MouthLowerLeft, "/mouthLeft", 0f },
        { UnifiedExpressions.MouthUpperRight, "/mouthRight", 0f },
        { UnifiedExpressions.MouthLowerRight, "/mouthRight", 0f },
